class Config(object):
    ...
    START_IMG = "https://files.catbox.moe/pausrx.jpg"

    DB_NAME = "Hanabi"

    SUPPORT_CHAT = "zenitsu_xsupport"  # Your Telegram support group chat username where your users will go and bother you
